...
- Apply the principles in
  [`shared/principles.md`](https://github.com/gominimal/ch-oracles/blob/main/shared/principles.md):
  think before acting, simplicity first, surgical changes, goal-driven
  execution.
- Apply the rigor checklist in
  [`shared/rigor.md`](https://github.com/gominimal/ch-oracles/blob/main/shared/rigor.md)
...
[`shared/safe-output-create-issue.md`](https://github.com/gominimal/ch-oracles/blob/main/shared/safe-output-create-issue.md):
